...
const adapters:Record<string,ProviderAdapter>={workers_ai:workersAiAdapter,gemini:geminiAdapter,openai:openaiAdapter,openai_compat:openaiCompatAdapter,deepseek:openaiCompatAdapter,kimi:openaiCompatAdapter,anthropic:anthropicAdapter};
